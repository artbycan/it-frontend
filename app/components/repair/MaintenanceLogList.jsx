    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg">
          ...
          <span className="font-bold">{totalCost.toLocaleString('th-TH')} บาท</span>
        </div>
      </div>
        ...
        >
          ...
          >
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="font-medium">
                  ครั้งที่ {log.log_no + 1}: {getActionTypeName(log.type_action)}
                </span>
            ...
            <span className="text-gray-400 transition-transform duration-200" 
                  style={{ transform: expandedLogs[log.log_id] ? 'rotate(180deg)' : '' }}>
              ▼
            </span>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                {log.spare_parts !== '-' && (
                  <div className="md:col-span-2">
                    ...
                    <p className="bg-white p-2 rounded">{log.spare_parts}</p>
                  </div>
                )}
                <div>
